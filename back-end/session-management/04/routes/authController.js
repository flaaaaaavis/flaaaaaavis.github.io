...
// {
//   "email@email.com": ["hashedPass"],
//   "email2@email.com": ["hashedPass2"]
// }

const displayControl = require('./displayController')
...
class Auth {
  ...
  createUser (req, res, shown, hidden) {
